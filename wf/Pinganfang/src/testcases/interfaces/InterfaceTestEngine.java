...
* @Package com.pinganfang.WTD.interfaceTest 
* @Description: To do something
* @author hekun hekun@pinganfang.com
* @date 2014年8月21日 下午4:05:37 
* @version V1.0   
 */
package testcases.interfaces;
...
public class InterfaceTestEngine {
	...
	public InterfaceTestEngine(String testApi,
			...
			Logger logger,List<Element> globalVaribles,String agreement) {
	...
	private void runCase() {
		...
		for (InterfaceTestEntity interfaceTest : interfaceTests) {
			...
			try {
				...
				String response = urlGenerator.doTest(false,sendType,agreement);
				String result="pass";
	...
	/**
	 * @param paraList
	 *           set the golbal varibles for interface case test
	 */
